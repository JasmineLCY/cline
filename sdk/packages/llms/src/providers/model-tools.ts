 ...
 * models, independent of the currently selected model. Settings surfaces use
 * this to explain provider-level availability; per-request attachment still
 * resolves through supportsModelTool with the selected model.
 */
